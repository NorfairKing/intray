...
, lib, mergeless, servant, servant-auth-client, servant-client
, servant-flatten, text, time, typed-uuid, validity
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    aeson base bytestring containers intray-api mergeless servant
